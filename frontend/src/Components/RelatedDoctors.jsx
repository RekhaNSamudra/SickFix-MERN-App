...
const RelatedDoctors = ({ speciality, docId }) => {
  ...
  return (
    <center className="mt-20 ">
      ...
      <p className="text-lg text-gray-700 mt-3">Simply browse through our extensive list of trusted doctors.</p>
      <div className="w-full grid grid-cols-auto gap-8 pt-5 gap-y-6 px-3 sm:px-0 mt-5">
